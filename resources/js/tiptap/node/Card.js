...
const padding = "py-1.5 md:py-2 px-6 md:px-8";
...
export const Card = Node.create({
    ...
    renderHTML({ HTMLAttributes }) {
        ...
        return [
            ...
            mergeAttributes(HTMLAttributes, {
                ...
                class: `flex flex-col border border-transparent rounded-[18px] ${padding} shadow-sm transition-colors w-full ${hClass} mb-6`
            }),
            0
        ];
    },
    ...
    addNodeView() {
        return ({ node, getPos, editor }) => {
            ...
            dom.className = `group relative flex flex-col ${initialHClass} ${currentColor.twClass} border border-dashed border-zinc-400/60 rounded-[18px] ${padding} shadow-sm focus-within:border-[#064F3B] focus-within:border-solid transition-colors w-full mb-6`;
            ...
            return {
                ...
                update: (updatedNode) => {
                    ...
                    dom.className = `${padding}  group relative flex flex-col ${newHClass} ${newColor.twClass} border border-dashed border-zinc-400/60 rounded-[18px] shadow-sm focus-within:border-[#064F3B] focus-within:border-solid transition-colors w-full mb-6 puntangina`;
