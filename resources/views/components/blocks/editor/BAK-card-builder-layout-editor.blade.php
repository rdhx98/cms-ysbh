...
<div
  class="flex flex-col gap-5 card-builder-layout-editor"
>
    ...
    >
      ...
      <div class="mt-2 border-t border-gray-300 pt-2 flex justify-end items-center gap-2">
        <button
          ...
          class="hover:border-foresty hover:text-foresty hover:bg-sage-soft flex items-center rounded-lg border border-dashed border-gray-300 bg-white p-1.5 text-xs font-bold text-gray-500 shadow-sm transition-colors outline-none gap-2" title="Teks"
        >
        ...
        <button
          ...
          class="hover:border-foresty hover:text-foresty hover:bg-sage-soft flex items-center rounded-lg border border-dashed border-gray-300 bg-white p-1.5 text-xs font-bold text-gray-500 shadow-sm transition-colors outline-none gap-2" title="Ikon"
        >
          <x-dynamic-component component="lucide-shapes" class="h3 w-3" /> Ikon
        </button>
      </div>
    </div>
  @endforeach
