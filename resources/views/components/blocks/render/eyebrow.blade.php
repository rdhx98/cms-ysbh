...
@if ($text)
  <div id="{{ $block['anchor'] ?? '' }}" class="mb-3 animate-scroll-reveal reveal">
    <span class="inline-flex items-center gap-2.5 font-['Instrument_Sans',sans-serif] text-[11px] md:text-[13px] font-bold tracking-[0.16em] uppercase" style="color: {{ $color }};">
