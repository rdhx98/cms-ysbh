        ...
        <form wire:submit.prevent="save" x-data="setupEditor('content', $wire)" @buka-modal-link.window="isLinkOpen = true" class="flex flex-col w-full h-full bg-zinc-50 dark:bg-zinc-950 rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-sm" wire:ignore>
            ...
            <div class="flex-none w-full bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 z-40">
                ...
                <div x-data="{ expanded: false }" class="border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/50 w-full">
                    {{-- <div class="max-w-7xl mx-auto w-full px-2 md:px-6"> --}}
                        ...
                        <div class="flex items-start md:items-center w-full">
                            <div x-data="{ isMobile: window.matchMedia('(pointer: coarse)').matches }"
                                ...
                                <div class="editor-toolbar flex flex-wrap gap-2 mb-3 pb-3 border-b border-gray-200">
                                    ...
                                    <button type="button" @click="insertSectionBlock2()"
                                        class="flex items-center gap-1 px-2 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50 transition-colors"
                                        title="Tambahkan Blok Seksi ">
                                        <svg class="w-4 h-4 text-forest" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2">
                                    ...
                                    <button type="button" @click="runCommand('setSectionBlock3')" class="flex items-center gap-1 px-2 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50 transition-colors">
                                        <x-dynamic-component :component="'lucide-square-dashed-bottom'" class="h-4 w-4 text-forest" stroke-width="2" />
                                        Seksi V3
                                    </button>
                                </div>
                            </div>
            ...
            <div class="transition-colors duration-300 ease-in-out w-full flex-1 flex flex-col min-h-0">
                ...
                {{-- EDITOR's AREA --}}
                <div
                class="flex-1 relative w-full h-full flex flex-col overflow-hidden bg-zinc-100 dark:bg-zinc-950"
                >
                    ...
                    <div
                        ...
                        <div class="w-full py-8 min-h-full flex flex-col">
                    ...
                    <div class="fixed bottom-6 right-8 pointer-events-none z-50">
                        <div
                            class="bg-zinc-100/90 dark:bg-zinc-800/90 backdrop-blur-sm border border-zinc-200 dark:border-zinc-700 text-zinc-500 dark:text-zinc-400 text-[10px] md:text-xs px-2.5 py-1 rounded-md shadow-sm font-medium tracking-wide">
