                ...
                <form method="POST" action="{{ route('login.store') }}" class=" ">
                    ...
                    <div class="relative mt-6">
                        <input
                            ...
                            class="peer w-full px-4 py-3 border-2 border-forest rounded-lg bg-transparent text-forest placeholder-transparent focus:outline-none focus:border-terracotta focus:text-terracotta transition-all"
                        />
                    ...
                    <div class="relative mt-6">
                        <input
                            ...
                            placeholder="************"
                            class="peer w-full pl-4 pr-12 py-3 border-2 border-forest rounded-lg bg-transparent text-forest placeholder-transparent focus:outline-none focus:border-terracotta focus:text-terracotta transition-all"
                        />
                        ...
                        <button
                            ...
                            class="absolute right-4 top-1/2 -translate-y-1/2 text-forest/70 hover:text-forest focus:outline-none focus:border-2 focus:rounded-lg focus:border-forest z-20"
                        >
                            ...
                            <svg x-show="showPassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#C0392B" class="w-5 h-5" x-cloak>
